...
public class MakelarSocialMediaAdapter extends RecyclerView.Adapter<MakelarSocialMediaAdapter.SocialMediaViewHolder> {
    private final Activity activity;
    private final List<UserSocialMedia> socialMediaData;

    public MakelarSocialMediaAdapter(Activity activity, List<UserSocialMedia> socialMediaData) {
    ...
    @NonNull
    @Override
    public MakelarSocialMediaAdapter.SocialMediaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.makelar_social_media_layout, parent, false);
        return new MakelarSocialMediaAdapter.SocialMediaViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(MakelarSocialMediaAdapter.SocialMediaViewHolder holder, int position) {
